 ...
 * 
 * AKA sample from the array with weight. If we just randomly pick an element,
 * the probability that a number got picked is proportional to the number of other numbers.
 * If we 
 */
